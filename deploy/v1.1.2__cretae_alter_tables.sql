...
ADD COLUMN IF NOT EXISTS ORDER_STATUS VARCHAR(20) DEFAULT 'COMPLETED';

-- Optional: enforce NOT NULL safely
UPDATE SALES_DATA
...
('Neha Verma', 'neha.verma@gmail.com', '9090909090', 'Female', '1995-11-02', 'Mumbai', 'Maharashtra', 'India'),
